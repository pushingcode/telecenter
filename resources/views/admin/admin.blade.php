...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/home" class="logo">
      ...
      <span class="logo-lg"><b>Epica</b>NERO</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="/check_disk"><i class="fa fa-hdd-o" aria-hidden="true"></i> <span>Estado del Disco</span></a></li>

        <!-- <li><a href="/manager/create"><i class="fa fa-link"></i> <span>Carga de Archivos</span></a></li> -->

        @hasanyrole('superadmin|admin')
        <li class="treeview">
          <a href="#"><i class="fa fa-file-archive-o"></i> <span>Gestor de Archivos</span>
        ...
        @hasanyrole('superadmin|admin')
        <li class="treeview">
          <a href="#"><i class="fa fa-heartbeat"></i> <span>Tecnicos</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/operador/create">Crear Tecnicos</a></li>
            <li><a href="/operador/masive">Gestion Masiva</a></li>
            <li><a href="/operador">Editar Tecnicos</a></li>
          </ul>
        </li>
        @endhasanyrole
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; {{ date('Y') }} <a href="#">EpicaNero</a>.</strong> All rights reserved.
  </footer>
